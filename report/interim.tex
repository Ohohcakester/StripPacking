...
\paragraph{Level-oriented algorithms} Level-oriented algorithms involve packing items into shelves of certain heights. These algorithms include First-Fit Decreasing Height, and Split-Fit.\\
\\
...
\\
For any list $L$ of rectangles, the performance of FFDH is bounded by the following:
\[
